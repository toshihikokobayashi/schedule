...
if ($action == 'add' || $action == 'delete' || $action == 'selected_buying_no') {
	//$student_no = trim($_POST["no"]);
	...
	//$buying_array["day"] = trim($_POST["day"]);
...
<form method="post" name="buying_textbook_form" action="buying_textbook_edit.php">
...
<!-- <?=$year?>年<?=$month?>月 -->
	...
	<tr>
		<td align="center">
			<input type="text" name="year" size="4" value="<?=$buying_array["year"]?>">年
		</td>
		<td align="center">
			<input type="text" name="month" size="4" value="<?=$buying_array["month"]?>">月
		</td>
		<td align="center">
...
<table border="1">
	<tr>
		<th>請求年月</th><th>記入日</th><th>テキストブック名</th><th>金額</th><th>教室</th><th>種類</th><th>&nbsp;</th>
	</tr>
 	<?php
